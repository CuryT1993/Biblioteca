...
<head>
    <meta charset="utf-8">
    <title>Hallyu Store- kpopwebsite</title>
...
<body>
            ...
            <div class="d-flex justify-content-between">
                <div class="top-info ps-2">
                    <small class="me-3"><i class="fas fa-map-marker-alt me-2 text-secondary"></i> <a href="#"
                            class="text-white">Edif.Plaza Colon 2.9 de Octubrey Colon frente al hotel
                            Ambassador</a></small>
                        ...
                        <div class="dropdown my-auto d-flex align-items-center">
                            <a class="dropdown-toggle text-decoration-none d-flex align-items-center gap-2" href="#"
                                ...
                                <span class="d-flex flex-column text-start lh-sm">
                                    <strong class="fw-semibold small">
                                        <?php echo htmlspecialchars($usuario['nombres']) ?>
                                    </strong>
                                    <small class="text-muted">(
                                        <?php echo htmlspecialchars($usuario['privilegio']) ?>)
                                    </small>
                                </span>
                                <?php endif; ?>
                            </a>
    ...
    <!-- Contacto Start -->
    <div class="container-fluid contacto py-5">
                ...
                <div class="row g-4">
                    <div class="col-12">
                        <div class="text-center mx-auto" style="max-width: 700px;">
                            ...
                            <p class="mb-4">El formulario de contacto está inactivo actualmente. Obtén un formulario de
                                contacto funcional con Ajax y PHP en minutos. Solo copia y pega los archivos, añade un
                                poco de código y listo.</a>.</p>
                        </div>
                    </div>
                    <div class="col-lg-7">
                        <form action="" class="">
                            <input type="text" class="w-100 form-control border-0 py-3 mb-4" placeholder="Su nombre">
                    ...
                    <div class="col-lg-5">
                        <div class="d-flex p-4 rounded mb-4 bg-white">
                            ...
                            <div>
                                <h4>Dirección</h4>
                                <h4>Edif. Plaza Colon 2, 9 de octubre y Colon, frente al hotel Ambassador.</h4>
                                <p class="mb-2"></p>
                            </div>
                        </div>
                        <div class="d-flex p-4 rounded mb-4 bg-white">
                            ...
                            <div>
                                ...
                                <p class="mb-2">hallyuatoreec@.com</p>
                            </div>
                        </div>
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="d-flex flex-column text-start footer-item">
                        ...
                        <a class="btn-link" href="">Contacto Us</a>
