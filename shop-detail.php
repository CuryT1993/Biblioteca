...
<body>
            ...
            <nav class="navbar navbar-light bg-white navbar-expand-xl">
                ...
                <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
                    <div class="navbar-nav mx-auto">
                        ...
                        <a href="shop-detail.php" class="nav-item nav-link active">Detalles de la Tienda</a>
       ...
       data-bs-toggle="dropdown" aria-expanded="false">
        ...
        <?php if ($usuario): ?>
            <span class="d-flex flex-column text-start lh-sm">
                <strong class="fw-semibold small"><?php echo htmlspecialchars($usuario['nombres']) ?></strong>
    ...
    <div class="container-fluid page-header py-5">
        <h1 class="text-center text-white display-6">Detalles de la Tienda</h1>
        <ol class="breadcrumb justify-content-center mb-0">
            <li class="breadcrumb-item"><a href="#">INICIO</a></li>
            <li class="breadcrumb-item"><a href="#">Paginas</a></li>
            <li class="breadcrumb-item active text-white">Detalles de la Tienda</li>
        </ol>
    </div>
    ...
    <div class="container-fluid bg-dark text-white-50 footer pt-5 mt-5">
        <div class="container py-5">
            <div class="pb-4 mb-4" style="border-bottom: 1px solid rgba(24, 61, 226, 0.5) ;">
                <div class="row g-4">
                    <div class="col-lg-3">
                        <a href="#">
